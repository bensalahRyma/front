...
const classes = {
  table:
    '[&_.rc-table-content]:overflow-x-auto [&_table]:w-50% [&_.rc-table-row:hover]:bg-gray-50 [&_.rc-table-row-expand-icon-cell]:w-14',
  thead:
  ...
  tCell:
    '[&_.rc-table-cell]:px-3 [&_th.rc-table-cell]:py-3 [&_td.rc-table-cell]:py-4 text-center',
  variants: {
    classic:

...
const data = [
  { name: 'Available storage', value: 20 },
  { name: 'Total used storage', value: 70 },
  { name: 'Available storage2', value: 8 },
  { name: 'Total used storage2', value: 2 },
];
const COLORS = ['#BFDBFE', '#0070F3',"#BFE5EF","#FFE497"];
  ...
  return (
    <>
      ...
      <text
        ...
        dominantBaseline="central"
      >
        <tspan fontSize="14px">{props.value3}</tspan>
      </text>
      <text
        x={cx}
        y={cy + 20}

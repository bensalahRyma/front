...
export const getColumns = () => [
  {
    title: <span className="ml-6 block  flex justify-center">Date</span>,
    dataIndex: 'date',
    key: 'date',
    width: 200,
    render: (date: Date) => (
  ...
  {
    title:  <span className="flex justify-center">Updated At</span>,
    dataIndex: 'updatedAt',
    key: 'updatedAt',
    width: 200,
  ...
  {
    title:<span className=" flex justify-center">Remarks</span> ,
    dataIndex: 'remarks',
    key: 'remarks',
    width: 200,
    render: (remarks: string) => <p className=" flex justify-center">{remarks}</p>,
  },
];

  ...
  >
    {item.message}
        ...
        <div className="mb-4 flex items-center justify-between border-b border-muted pb-4 last:mb-0 last:border-0 last:pb-0">
          ...
          <Text as="span" className=" w-10 h-10 text-sm text-gray-600 dark:text-gray-700 flex items-center justify-center">
      Status
    </Text>
          <Text as="span" className="flex items-center justify-center">Fraud Score</Text>
        </div>
        ...
        data-color={statusColors(item?.status)}
      >
          {item?.status}
      </Badge>
    ...
    >
      ...
      <div className="flex justify-center">
         ...
         <Button as='span'  className="mt-4"  variant="outline" onClick={handleShowAll} >

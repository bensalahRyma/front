...
import DateFilter from '@/components/controlled-table/date-filter';
...
export default function ActivityHistoryTable({
  ...
  className?: string;
    ...
    const filteredDataActivity = dataActivity.filter((item) => {
  ...
  return (
    ...
    >
      {/* Render the DateFilter component */}
      <DateFilter onDateChange={handleDateChange} />

      {/* Render the BasicTableWidget with filtered data */}
      <BasicTableWidget
        className={cn('pb-0 lg:pb-0 [&_.rc-table-row:last-child_td]:border-b-0')}
        data={filteredDataActivity} // Use filtered data

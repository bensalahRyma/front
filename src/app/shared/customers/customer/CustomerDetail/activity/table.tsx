...
import { statusColors } from '@/app/shared/logistics/shipment/list/columns';
...
export default function ShipmentListTable() {
  ...
  const {
    ...
    setSelectedRowKeys,
    selectedRowKeys,
  } = useTable(dataActivity, pageSize, filterState);

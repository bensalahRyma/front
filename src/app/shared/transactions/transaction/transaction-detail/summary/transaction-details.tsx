...
export default function TransactionDetails({ className }: DeliveryDetailsProps) {
  ...
  const handleStatusChange = (index: number, newStatus: string) => {
   ...
   const getColumns = ({  onHeaderCellClick}: Columns) => [
    {
    ...
    {
      title:<span className="block flex justify-center">Amount</span> ,
      dataIndex: 'amount',
      key: 'amount',
      width: 100,
    ...
    {
      title:<span className="block flex justify-center">Date</span>,
      dataIndex: 'date',
      key: 'date',
      width: 100,
